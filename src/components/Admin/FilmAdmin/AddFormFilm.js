...
useEffect(() =>{
  ...
  return (
      ...
      <FormGroup className="mb-3 mr-sm-2 mb-sm-0">
        ...
        <Input type="text" name="movie_name" id="fim-name" onChange = {handleChange} />
      </FormGroup>
      <FormGroup className="mb-3 mr-sm-2 mb-sm-0">
        <Label for="director" className="mr-sm-2">Đạo diễn</Label>
        <Input type="text" name="movie_director" id="director" onChange = {handleChange} />
      </FormGroup>
      <FormGroup className="mb-3 mr-sm-2 mb-sm-0">
        ...
        <option value="DEFAULT" disabled>Chọn thể loại phim ... </option>
      ...
      <FormGroup className="mb-3 mr-sm-2 mb-sm-0">
        ...
        <Input type="text" name="movie_trailer" id="film-trailer" onChange = {handleChange}/>
      </FormGroup>
      <FormGroup className="mb-3 mr-sm-2 mb-sm-0">
      <Label for="film-des">Miêu tả phim</Label>
        <Input type="textarea" name="movie_describe" id="film-des" onChange = {handleChange}/>
      </FormGroup>
      </div>
  );
}
